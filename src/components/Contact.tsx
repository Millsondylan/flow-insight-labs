      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Ready to add AI to your platform? Contact our team to discuss your needs and see how we can help your business grow.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          ...
          >
            ...
            <CardContent className="relative z-10">
              <p className="text-muted-foreground mb-6 text-lg leading-relaxed">
                Get help with setup and technical questions from our support team.
              </p>
              <a 
          ...
          >
            ...
            <CardContent className="relative z-10">
              <p className="text-muted-foreground mb-6 text-lg leading-relaxed">
                Get quick support and advice through WhatsApp for fast help.
              </p>
              <Button 
                variant="premium" 
